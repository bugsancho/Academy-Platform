namespace AcademyPlatform.Web.Umbraco.Areas.Admin.Controllers
{
    ...
    [UmbracoAuthorize]
    public class CoursesAdminController : SurfaceController
    {
        ...
        public CoursesAdminController(ICoursesService coursesService, IHtmlSanitizer sanitizer, ICategoryService categories)
        {
